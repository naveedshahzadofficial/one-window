        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom ">
                ...
                <div class="card-body p-0">
                    ...
                    {{ Form::open(array('route' => ['applicant.registrations.applications.store', $registration],'class'=>'kt_auth_form','name'=>'certification_form','id'=>'certification_form')) }}
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <a href="{{ route('applicant.registrations.index') }}" class="btn btn-secondary">Cancel</a>
