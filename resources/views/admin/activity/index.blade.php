    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('admin.activities.create') }}" class="btn btn-custom-color font-weight-bolder">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            myDataTable = $('#my_datatable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{{ route('admin.activities.index-ajax') }}',
                    type: "POST"
                },
                columns: [
                    {data: 'id', searchable: false, visible: false, printable: false},
                    {data: 'activity_name', name: 'activity_name'},
                    {data: 'activity_status', name: 'activity_status', class: 'text-center'},
