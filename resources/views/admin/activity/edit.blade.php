            ...
            <div class="card card-custom ">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Update Activity</h3>
                    </div>
                </div>
                    ...
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('activity_order') is-invalid @enderror" name="activity_order"
                                   value="{{ old('activity_order')??$activity->activity_order }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="activity_remark" class="form-control @error('activity_remark') is-invalid @enderror" rows="2">{{ old('activity_remark')??$activity->activity_remark }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('activity_status')=='1' || $activity->activity_status=='1')checked="checked"@endif name="activity_status" value="1">
                                    <span></span>Active</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('activity_status')=='0' || $activity->activity_status=='0')checked="checked"@endif name="activity_status" value="0">
