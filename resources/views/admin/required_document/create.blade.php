...
@push('title','Add Required Documents')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom ">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Add Required Document</h3>
                    </div>
                </div>

                <div class="card-body p-0">
                    {{ Form::open(array('route' => 'admin.required-documents.store','class'=>'form form-horizontal','name'=>'required_document_form','id'=>'required_document_form')) }}
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="document_remarks" class="form-control @error('document_remarks') is-invalid @enderror" rows="2">{{ old('document_remarks') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('document_status')=='Active')checked="checked"@endif name="document_status" value="Active">
                                    <span></span>Active</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('document_status')=='Inactive')checked="checked"@endif name="document_status" value="Inactive">
