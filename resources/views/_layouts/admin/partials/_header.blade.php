								...
								<div class="dropdown" id="kt_quick_search_toggle">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                        ...
                                        @section('dropdown-search')
                                            @include('_layouts.admin.partials._extras.dropdown.search-dropdown')
                                        @show
									</div>
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<form>
                                            ...
                                            @section('dropdown-notifications')
                                                @include('_layouts.admin.partials._extras.dropdown.notifications')
                                            @show
										</form>
									</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                        ...
                                        @section('dropdown-quick-actions')
                                            @include('_layouts.admin.partials._extras.dropdown.quick-actions')
                                        @show
									</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        @section('dropdown-languages')
                                            @include('_layouts.admin.partials._extras.dropdown.languages')
                                        @show
									</div>
