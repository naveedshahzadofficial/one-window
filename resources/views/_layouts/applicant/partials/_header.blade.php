							...
							<div class="topbar">
								...
								<div class="dropdown" id="kt_quick_search_toggle">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                        ...
                                        @section('dropdown-search')
                                            @include('_layouts.applicant.partials._extras.dropdown.search-dropdown')
                                        @show
									</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<form>
                                            ...
                                            @section('dropdown-notifications')
                                                @include('_layouts.applicant.partials._extras.dropdown.notifications')
                                            @show
										</form>
									</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                        ...
                                        @section('dropdown-quick-actions')
                                            @include('_layouts.applicant.partials._extras.dropdown.quick-actions')
                                        @show
									</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        @section('dropdown-languages')
                                            @include('_layouts.applicant.partials._extras.dropdown.languages')
                                        @show
									</div>
								...
								<div class="dropdown">
									...
									<div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
										<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
											...
											<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ \Illuminate\Support\Str::before(auth()->user()->name,' ') }}</span>
											<span class="symbol symbol-35 symbol-light-success">
												<span class="symbol-label font-size-h5 font-weight-bold">{{ \Illuminate\Support\Str::upper(\Illuminate\Support\Str::substr(auth()->user()->name,0,1)) }}</span>
											</span>
										</div>
									</div>
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                                        ...
                                        @section('dropdown-user')
                                            @include('_layouts.applicant.partials._extras.dropdown.user')
                                        @show
									</div>
