    ...
    public function indexAjax(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function($row){
                $actionBtn = '<a href="'.route('applicant.applications.edit',$row->id).'" class="edit btn btn-custom-color text-center btn-icon btn-xs"><i class="flaticon-edit text-white"></i></a>&nbsp;<a href="'.route('applicant.applications.show',$row->id).'" class="edit btn btn-custom-color text-center btn-icon btn-xs"><i class="flaticon-eye text-white"></i></a>';
                return $actionBtn;
            })
            ->rawColumns(['action'])
            ->make(true);
