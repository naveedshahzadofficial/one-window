...
class RlcoResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "fee" => !empty($this->fee) && ((int) filter_var($this->fee, FILTER_SANITIZE_NUMBER_INT)) > 0?number_format((float)((int) filter_var($this->fee, FILTER_SANITIZE_NUMBER_INT))):'Not Applicable',
            ...
            "renewal_fee" =>  ($this->renewal_required=='Yes') && !empty($this->renewal_fee) && ((int) filter_var($this->renewal_fee, FILTER_SANITIZE_NUMBER_INT)) > 0?number_format((float)((int) filter_var($this->renewal_fee, FILTER_SANITIZE_NUMBER_INT))):'Not Applicable',
