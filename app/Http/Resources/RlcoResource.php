...
class RlcoResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "fee" => $this->fee_question=='Yes' && $this->fee_plan=='Single Fee'?number_format($this->fee):'Not Applicable',
            "fee_schedule" => $this->fee_schedule,
            "renewal_required" => $this->renewal_required,
            "renewal_fee_plan" => $this->renewal_fee_plan,
            "renewal_fee" =>  $this->renewal_required=='Yes' && $this->renewal_fee_plan=='Single Fee'?number_format($this->renewal_fee):'Not Applicable',
